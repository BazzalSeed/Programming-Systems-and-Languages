...
*/
Scanner::Scanner(std::ifstream & r) : iof(r), start_index(StartIndices::ARRAY_START_INDEX), valid_index(StartIndices::ARRAY_START_INDEX), index(StartIndices::PEEK_START_INDEX)
{
